...
class AuthManager:
    ...
    async def async_create_refresh_token(
        ...
        token_type = self._resolve_token_type(user, token_type)
        self._validate_user_token_compatibility(user, token_type, client_id, client_name)
        self._validate_unique_long_lived_token(user, token_type, client_name)

        expire_at = self._get_expiration(token_type)
    ...
    def _validate_user_status(self, user: models.User ) -> None:
        if not user.is_active:
            raise ValueError("User is not active")



    def _resolve_token_type(self, user: models.User, token_type: str | None) -> str:
    ...
    def _validate_user_token_compatibility(self, user: models.User, token_type: str | None, client_id: str | None, client_name: str | None) -> None:
        ...
        if token_type == models.TOKEN_TYPE_LONG_LIVED_ACCESS_TOKEN and not client_name:
    ...
    def _get_expiration(self, token_type: str) -> float | None:
